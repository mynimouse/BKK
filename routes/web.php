...
Route::group(['middleware' => 'checkRole:admin'], function () {
    ...
    Route::get('/dashboard/pendaftar/edit/{lowongan:slug}/', [DashboardLamaranController::class, 'edit']);
    Route::post('/dashboard/pendaftar/', [DashboardLamaranController::class, 'update'])->name('update-lamaran');
});
